...
class Element implements \ArrayAccess
{
   ...
   *
   */
  public function __construct ($xml, $opts=[])
  {
  ...
  public function add ($element)
  {
    ...
    {
      \Lum\XML\Simple::append($this->xml, $element->xml);
      return $element;
    }
   ...
   *
   * 'xml'     (boolean)        If true, keep the XML declarator.
   * 
   * 'doctype' (string|numeric) The HTML document type, see below.
   *
   ...
   *
   * If the 'doctype' is omitted, we don't add any.
   *
   ...
   *
   * Using this method, no XML declarator, or HTML DOCTYPE will be added.
   * If you need either of those, use to_html() instead.
   */
